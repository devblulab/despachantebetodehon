...
const tutorialSteps = [
  ...
  },
  {
    ...
    content: 'Revise os dados e clique em "Enviar Arquivos". Aguarde 5 segundos para a confirmação de salvamento.',
  },
];
      ...
      >
        ...
        <div className={classes.actionBar}>
          <Button
            ...
            disabled={isLoading}
          >
            {isLoading ? <CircularProgress size={24} /> : 'Enviar Arquivos'}
          </Button>
        </div>
      </Paper>
